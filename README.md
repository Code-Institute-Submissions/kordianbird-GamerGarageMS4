...
* I used google fonts to import 'audiowide', 'mono' and 'tourney' fonts which I used for headings and logo

* I used font awesome to add icons in certain parts of the project like the cart
